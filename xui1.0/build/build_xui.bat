...
xcopy %relPath%xui\js\Com\*.* %outPath%xui\js\Com\ /E /Y
...
rem for adv code
rem ==================
copy %relPath%xui\js\UI\FusionChartFree.js /b + %relPath%xui\js\UI\FusionChart3.js /b + %relPath%xui\js\UI\TextEditor.js /b + %relPath%xui\js\UI\TimeLine.js /b +  %relPath%xui\js\UI\TagEditor.js /b + %relPath%xui\js\UI\FoldingTabs.js /b + %relPath%xui\js\UI\Poll.js /b + %relPath%xui\js\UI\FoldingList.js /b + %relPath%xui\js\UI\Range.js /b  + %relPath%xui\js\UI\Calendar.js /b adv.js
