     ...
     header: [
        {
            ...
            "colResizer":false,
            "type" : "label",
            "renderer" : function(cell){return "<span  class='xui-node-span' style='width:16px;height:16px;background:url(img/img.gif) left top'></span>"+cell.caption},
            "cellRenderer" : function(cell){return "<span  class='xui-node-span' style='width:16px;height:16px;background:url(img/img.gif) left -16px'></span>"+cell.value},
            "width" : 120
        },
        {
            "id" : "col2",
    ...
    rows: [
        ...
        },
        {
            ...
            },
            {
                ...
                "editable":true,
                "cellRenderer" : function(cell){return xui.Date.getText(cell.value, 'ymd2')}
            },
            '00:00',
            {
                value:'a',
