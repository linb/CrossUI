...
(function(){
    ...
    */
    ...
    _.set(xui.Locale,["cn","doc","xui","UI"], {
        ...
        prototype:{
            ...
            busy:{
                ...
                $snippet:[
                    "var id='xui.temp.tl1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
            ...
            free:{
                ...
                $rtn:"[self]",
                $snippet:[
                    "var id='xui.temp.tl2'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
                    "o.busy('Loading message');"+
                    "_.asyRun(function(){o.free()},1000);"+
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","Label"], {
        ...
        prototype:{
            ...
            getCaption :{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.lbl1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
            ...
            getHAlign :{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.lbl7'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var btn;xui(id).prepend(btn=new xui.UI.Label({border:true,height:'50',width:'100'}));"+
            ...
            getShadowText :{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.lbl11'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var btn;xui(id).prepend(btn=new xui.UI.Label({border:true,height:'50',width:'100'}));"+
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","SLabel"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.SLabel 类",
        constructor:{
            $desc:"生成一个xui.UI.SLabel."
        },
        prototype:{
            KEY:{$desc:"本类名"},
            getCaption :{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.SLabel1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var btn;xui(id).prepend(btn=new xui.UI.SLabel);"+
                    "_.asyRun(function(){btn.setCaption ('tag'); alert(btn.getCaption ())},1000)"+
                    "}"
                ]
            },
            ...
            getHAlign :{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.SLabel7'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","SButton"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.SButton 类",
        constructor:{
            $desc:"生成一个xui.UI.SButton对象."
        },
        prototype:{
            KEY:{$desc:"本类名"},
            activate:{
            ...
            getHAlign :{
                ...
                $snippet:[
                    ...
                    "var btn;xui(id).prepend(btn=new xui.UI.SButton({border:true,width:'100'}));"+
                    "_.asyRun(function(){btn.setHAlign('center'); alert(btn.getHAlign())},1000)"+
                    "}"
                ]
            },
            ...
            onClick:{
                ...
                $snippet:[
                    ...
                    "xui(id).prepend((new xui.UI.SButton()).onClick(function(profile){alert(profile.properties.caption)}));"+
                    "}"
                ]
            }
        }
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","SCheckBox"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.SCheckBox 类",
        constructor:{
        ...
        prototype:{
            ...
            onChecked:{
                ...
                $snippet:[
                    ...
                    "xui(id).prepend((new xui.UI.SCheckBox()).onChecked(function(profile,e,value){alert(value)}));"+
                    "}"
                ]
            }
        }
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","CheckBox"], {
        ...
        prototype:{
            ...
            onChecked:{
                ...
                $snippet:[
                    "var id='xui.temp.cbtn18'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:10px;\">' + '<br /><button onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","Range"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.Range 类",
        constructor:{
            $desc:"生成一个xui.UI.Range对象."
        },
        prototype:{
            KEY:{$desc:"本类名"},
            getCaptionTpl :{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.rg1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o;xui(id).prepend(o=new xui.UI.Range);"+
            ...
            getMax:{
                ...
                $rtn:"Number",
                $snippet:[
                    "var id='xui.temp.rg3'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o;xui(id).prepend(o=new xui.UI.Range);"+
            ...
            getMin:{
                ...
                $rtn:"Number",
                $snippet:[
                    "var id='xui.temp.rg5'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o;xui(id).prepend(o=new xui.UI.Range);"+
            ...
            getSingleValue:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.rg7'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o;xui(id).prepend(o=new xui.UI.Range);"+
            ...
            getSteps:{
                ...
                $rtn:"Number",
                $snippet:[
                    "var id='xui.temp.rg9'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o;xui(id).prepend(o=new xui.UI.Range);"+
            ...
            getUnit:{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.rg11'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;height:100px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o;xui(id).prepend(o=new xui.UI.Range);"+
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","ColLayout"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.ColLayout 类",
        prototype:{
            getMinWidth:{
                $desc:"获取最小宽度限制.",
                $rtn:"Number"
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","Calendar"], {
        ...
        prototype:{
            ...
            addContents:{
                ...
                $paras:[
                 "index [必需参数] : Number, 0-41, 第几天.",
                 "node [必需参数] : xui.absBox, 要加入的Dom/UI控件."
                ]
            },
            setWidth:{
                $desc:"设置控件的宽度.（单位px）.",
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","Poll"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.Poll 类",
        constructor:{
            $desc:"生成一个投票对象."
        ...
        prototype:{
            ...
            fillContent:{
                ...
                $paras:[
                    ...
                    "obj [必需参数]: xui.Dom/xui.UI, 如果是 null, 会清空项的内容."
                ],
                $snippet:[
                    "var id='xui.temp.poll3'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){o.fillContent('a', new xui.UI.Button({position:'relative'}))},1000);"+
                    "}"
                ]
            },
            getBindEditor:{
                ...
                $rtn:"xui.UIProfile",
                $snippet:[
                    "var id='xui.temp.poll4'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({editable:true, width:'auto',height:'auto',title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "xui(id).prepend(o);"+
            ...
            getRemoveText:{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.pool5'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true,selMode:'multi',title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
            ...
            setRemoveText:{
                ...
                $snippet:[
                    ...
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true,title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getRemoveText());o.setRemoveText('remove me');"+
                    "xui(id).prepend(o);"+
                    "}"
                ]
            ...
            getEditorType:{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.pool7'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true,title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
            ...
            getEditable:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.pool9'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getEditable());"+
                    "xui(id).prepend(o);"+
            ...
            setEditable:{
                ...
                $snippet:[
                    ...
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey',newOption:'new', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getEditable());"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){o.setEditable(true)},1000)"+
                    "}"
            ...
            getNewOption:{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.pool11'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey',selMode:'multi', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
            ...
            getToggle:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.pool13'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey', position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getToggle());"+
                    "xui(id).prepend(o);"+
            ...
            setToggle:{
                ...
                $snippet:[
                    ...
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',selMode:'multi',title:'a survey', position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getToggle());"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){o.setToggle(true)},1000)"+
                    "}"
            ...
            getTitle:{
                ...
                $rtn:"String",
                $snippet:[
                    "var id='xui.temp.pool15'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getTitle());"+
                    "xui(id).prepend(o);"+
            ...
            getNoTitle:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.pool19'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',title:'a survey', position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "alert(o.getNoTitle());"+
                    "xui(id).prepend(o);"+
            ...
            beforeOptionAdded:{
                ...
                $snippet:[
                    "var id='xui.temp.pool41'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true,title:'a survey',newOption:'new', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "o.beforeOptionAdded(function(p,s){xui.message('beforeOptionAdded'+':'+s)});"+
                    "o.beforeOptionChanged(function(p,i,s){xui.message('beforeOptionChanged'+':'+s)});"+
                    "o.beforeOptionRemoved(function(p){xui.message('beforeOptionRemoved')});"+
                    "o.beforeTitleChanged(function(p,s){xui.message('beforeTitleChanged'+':'+s)});"+
                    "xui(id).prepend(o);"+
                    "}"
                ]
            },
            beforeOptionChanged:{
                ...
                $snippet:[
                    "var id='xui.temp.pool42'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true,title:'a survey',newOption:'new', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "o.beforeOptionAdded(function(p,s){xui.message('beforeOptionAdded'+':'+s)});"+
                    "o.beforeOptionChanged(function(p,i,s){xui.message('beforeOptionChanged'+':'+s)});"+
                    "o.beforeOptionRemoved(function(p){xui.message('beforeOptionRemoved')});"+
            ...
            beforeTitleChanged:{
                ...
                $snippet:[
                    "var id='xui.temp.pool44'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true,title:'a survey',newOption:'new', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "o.beforeOptionAdded(function(p,s){xui.message('beforeOptionAdded'+':'+s)});"+
                    "o.beforeOptionChanged(function(p,i,s){xui.message('beforeOptionChanged'+':'+s)});"+
                    "o.beforeOptionRemoved(function(p){xui.message('beforeOptionRemoved')});"+
            ...
            onCustomEdit:{
                ...
                $snippet:[
                    "var id='xui.temp.pool45'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;width:300px;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.Poll({width:'auto',height:'auto',editable:true, title:'a survey',newOption:'new', toggle:true, position:'relative',items:[{id:'a',caption:'option 1',percent:0.5,message:'50%'},{id:'b',caption:'option 2',percent:0.8,message:'80%'}]});"+
                    "o.onCustomEdit(function(profile, node, flag, value, item, callback){"+
                    "if(flag==1||flag==2){var p=new xui.UI.PopMenu({items:[{id:'a',caption:'item a',tips:'item a'},{id:'b',image:'img/img.gif',caption:'itemb',tips:'item b'}]});p.pop(node);p.onMenuSelected(function(p,i){callback(i.caption)}); return p;};"+
                    "});"+
                    "xui(id).prepend(o);"+
                    "}"
                ]
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","TimeLine"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.TimeLine 类",
        constructor:{
            $desc:"生成一个xui.UI.TimeLine对象."
        },
        prototype:{
            KEY:{$desc:"本类名"},
            scrollToLeft:{
            ...
            getTimeRange:{
                ...
                $rtn:"Array",
                $snippet:[
                    "var id='xui.temp.tl2-1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){xui.message(o.getTimeRange())},1000);"+
                    "}"
                ]
            },
            addTasks:{
                ...
                $snippet:[
                    "var id='xui.temp.tl3'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
            ...
            removeTasks:{
                ...
                $snippet:[
                    "var id='xui.temp.tl3-1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            getCloseBtn:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.tl4'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            getZoomable:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.tl4-1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            setZoomable:{
                ...
                $rtn:"[self]",
                $snippet:[
                    "var id='xui.temp.tl4-2'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            getIncrement:{
                ...
                $rtn:"Number",
                $snippet:[
                    "var id='xui.temp.tl4-3'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            setIncrement:{
                ...
                $rtn:"[self]",
                $snippet:[
                    "var id='xui.temp.tl4-4'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){o.setIncrement(30);alert(o.getIncrement())},1000);"+
                    "}"
            ...
            getTaskHeight:{
                ...
                $rtn:"Number",
                $snippet:[
                    "var id='xui.temp.tl4-5'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            getOptBtn:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.tl6'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            getDftTaskName:{
                ...
                $rtn:"Boolean",
                $snippet:[
                    "var id='xui.temp.tl8'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            getDateStart:{
                ...
                $snippet:[
                    "var id='xui.temp.tl20'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative', multiTasks:true});"+
                    "xui(id).prepend(o);"+
                    "alert(o.getDateStart());"+
                    "_.asyRun(function(){o.setDateStart(xui.Date.add(new Date,'d',1))},1000);"+
                    "}"
                ]
            },
            setDateStart:{
            ...
            getMultiTasks:{
                ...
                $rtn:'Boolean',
                $snippet:[
                    "var id='xui.temp.tl22'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            getMinDate:{
                ...
                $snippet:[
                    "var id='xui.temp.tl24'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){o.setMinDate(xui.Date.add(new Date,'d',-2));alert(o.getMinDate());},1000);"+
                    "}"
                ]
            },
            setMinDate:{
            ...
            getMaxDate:{
                ...
                $rtn:'Object, Date Ojbect',
                $snippet:[
                    "var id='xui.temp.tl26'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
                    "_.asyRun(function(){o.setMaxDate(xui.Date.add(new Date,'d',3));alert(o.getMaxDate());},1000);"+
                    "}"
                ]
            },
            setMaxDate:{
            ...
            getReadonly:{
                ...
                $rtn:'Boolean',
                $snippet:[
                    "var id='xui.temp.tl28'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            getShowTips:{
                ...
                $rtn:'Boolean',
                $snippet:[
                    "var id='xui.temp.tl30'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            getShowBar:{
                ...
                $rtn:'Boolean',
                $snippet:[
                    "var id='xui.temp.tl32'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            getShowBigLabel:{
                ...
                $rtn:'Boolean',
                $snippet:[
                    "var id='xui.temp.tl34'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            getTimeSpanKey:{
                ...
                $rtn:'String',
                $snippet:[
                    "var id='xui.temp.tl36'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            getUnitPixs:{
                ...
                $rtn:'Number',
                $snippet:[
                    "var id='xui.temp.tl38'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
            ...
            visibleTask:{
                ...
                $rtn:"[self]",
                $snippet:[
                    "var id='xui.temp.tl41'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative'});"+
                    "xui(id).prepend(o);"+
                    "o.setValue(xui.Date.add(new Date,'h',-3).getTime()+':'+xui.Date.add(new Date,'h',3).getTime());"+
            ...
            iniContent:{
                ...
                $rtn:"[self]",
                $snippet:[
                    "var id='xui.temp.tl53-1'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative',multiTasks:true});"+
                    "xui(id).prepend(o);"+
            ...
            beforeDragTask:{
                ...
                $snippet:[
                    "var id='xui.temp.tl50-2'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative',closeBtn:true});"+
                    "xui(id).prepend(o);"+
            ...
            beforeClose:{
                ...
                $snippet:[
                    "var id='xui.temp.tl50'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative',closeBtn:true});"+
                    "xui(id).prepend(o);"+
                    "o.beforeClose(function(){return false;});"+
                    "}"
            ...
            onShowOptions :{
                ...
                $snippet:[
                    "var id='xui.temp.tl51'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative',optBtn:true});"+
                    "xui(id).prepend(o);"+
                    "o.onShowOptions(function(){alert('onShowOptions');});"+
                    "}"
                ]
            ...
            onClickTask:{
                ...
                $snippet:[
                    "var id='xui.temp.tl52'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative',multiTasks:true});"+
                    "o.addTasks([{id:'task1',caption:'task 1',from:(new Date).getTime(), to:(new Date).getTime()+1000*60*60*4 }]);"+
                    "xui(id).prepend(o);"+
            ...
            onGetContent:{
                ...
                $snippet:[
                    "var id='xui.temp.tl53'; if(!xui.Dom.byId(id)){this.prepend(xui.create('<div id='+id+' style=\"border:solid 1px;padding:20px;position:relative;\">' + '<button style=\"position:absolute; bottom:0px; z-index:2;\" onclick=\"xui(this).parent().remove()\">remove this example</button>' + '</div>'));"+
                    "var o=new xui.UI.TimeLine({position:'relative',multiTasks:true});"+
                    "o.onGetContent(function(p,from,to,minMs,type){xui.message(from.getTime()+':'+to.getTime()+':'+minMs+':'+type);});"+
                    "xui(id).prepend(o);"+
                    "}"
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","FusionChartFree"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.FusionChartFree 类",
        constructor:{
            $desc:"生成一个xui.UI.FusionChartFree对象."
        },
        replaceSpecialChars:{
    ...
    _.set(xui.Locale,["cn","doc","xui","UI","FusionChart3"], {
        KEY:{$desc:"本类名"},
        $desc:"xui.UI.FusionChart3 类",
        constructor:{
            $desc:"生成一个xui.UI.FusionChart3对象."
        },
        prototype:{
            KEY:{$desc:"本类名"},
            hasRendered:{
