Class('App', 'xui.Com',{
    Instance:{
        ...
        iniComponents:function(){
            ...
            host.ctl_pane55.append(
                (new xui.UI.FoldingTabs())
            ...
            host.block8.append(
                ...
                .setItems([{
                    "id" : "a",
                    "caption" : "buttonview a",
                    "image" : "img/demo.gif",
                    "closeBtn" : true,
                    "popBtn" : true
                },{
                    "id" : "b",
                    "caption" : "buttonview b",
                    "image" : "img/demo.gif",
                    "closeBtn" : true,
                    "popBtn" : true
                },{
                    "id" : "c",
                    "caption" : "buttonview c"
                }])
                .setBarSize(28)
                .setValue("a")
                );
            
            host.buttonviews2.append(
                (new xui.UI.Group())
                .setHost(host,"group1")
                .setLeft(10)
                .setTop(10)
            ...
            host.tabs2.append(
                (new xui.UI.ComboInput())
                .setHost(host,"ctl_comboinput298")
                .setReadonly(true)
                .setLeft(240)
                .setTop(113)
                .setValue("ComboInput")
            ...
            host.tabs2.append(
                (new xui.UI.ComboInput())
                .setHost(host,"ctl_comboinput352")
                .setLeft(240)
                .setTop(67)
