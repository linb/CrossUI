...
xui.Class('App.BoxShadow', 'xui.Module',{
    Instance:{
        iniComponents : function(){
            ...
            host.ctl_group1.append(
                ...
                .setWidth(180)
                .setHeight(110)
                .setHtml("<font size=\"4\"><b><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp; <font size=\"4\">Box</font> Shadow</b><br></font>")
        ...
        setTS:function(){
            ...
            node.css('boxShadow', (values.inset?("inset "):"")+values.hl + "px " + values.vl + "px " + values.br + "px " + values.clr);
                                      
            this.i_cssStyle.setValue("box-shadow : "+node.css("boxShadow"));
        },
